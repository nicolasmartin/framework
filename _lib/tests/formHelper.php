<?php
	...
	class TestOfFormHelper extends UnitTestCase {
		...
		public function testCheckboxes() {
		    $this->assertEqual(
		        FormHelper::checkboxes('name', '1', array('1' => 'un', '2' => 'deux'), array('class' => 'myClass')),
            ...
            $this->assertEqual(
                 FormHelper::checkboxes('name', array('1', '2') , array('1' => 'un', '2' => 'deux'), array('class' => 'myClass')),
                 '<input type="checkbox" name="name" class="myClass" value="1" checked="checked"> un '.
		...
		public function testRadios() {
		    $this->assertEqual(
		        FormHelper::radios('name', '1', array('1' => 'un', '2' => 'deux'), array('class' => 'myClass')),
		        '<input type="radio" name="name[]" class="myClass" value="1" checked="checked"> un '.
		        '<input type="radio" name="name[]" class="myClass" value="2"> deux ');

		    $this->assertEqual(
		        FormHelper::radios('name', array('1', '2') , array('1' => 'un', '2' => 'deux'), array('class' => 'myClass')),
		        '<input type="radio" name="name[]" class="myClass" value="1" checked="checked"> un '.
