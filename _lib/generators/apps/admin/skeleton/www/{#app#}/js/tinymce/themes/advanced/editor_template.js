...
*/
		...
		_mceCodeEditor : function(ui, val) {
			...
			ed.windowManager.open({
				...
				height : parseInt(ed.getParam("theme_advanced_source_editor_height", 600)),
				inline : true,
				resizable : true,
				maximizable : true
			}, {
		...
		_mceImage : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 380 + parseInt(ed.getLang('advanced.image_delta_width', 0)),
				height : 320 + parseInt(ed.getLang('advanced.image_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
